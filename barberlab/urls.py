...
from apps.barbero.views import AgendaTurnosView, LoginStaffView
...
urlpatterns = [
    ...
    path('acceso/', LoginStaffView.as_view(), name='login_staff'), 
    path('agenda/', AgendaTurnosView.as_view(), name='agenda'),
